...
- **Design requirement:** The journey must be useful even if the user refuses every optional field and leaves after reading scope/privacy.

| Step | Classification | Screen / decision | Data and consent | Success / exit |
| ---: | --- | --- | --- | --- |
| 0 | Design requirement | “For adults using this for themselves” plus not therapy/diagnosis/emergency/full-device guarantee. | No data. | Understand / leave to reviewed resources. |
| 1 | Design requirement | “Private by default” summary: local only, what is not collected, shared-device warning, delete/export limits. | No bundled external consent. | Continue / leave. |
...
| 5 | Design requirement | Plan preview: exact stored fields, no monitoring, no person notified, edit/delete controls. | Explicit save-to-device action. | Save / use without save / discard. |
...
| 8 | Design requirement | Home shows Plan, Pause, Learn, Privacy/Exit; no feed, streak, score, paywall, or notification prompt. | Local state summary. | Delete all / close. |

## Copy rules

| Classification | Use | Avoid |
| --- | --- | --- |
| Design requirement | “your goal,” “pause,” “next step,” “private plan,” “setback,” “what helps” | addicted, clean/dirty, failed, cured, relapse prevented, risky person |
| Hypothesis | “This may help you create a pause.” | “This will stop the urge.” |
| Design requirement | “The web app does not monitor other apps or devices.” | “You are protected.” |
| Design requirement | “Nothing is sent to another person in this version.” | Absolute “anonymous” or “no one can ever see this.” |

## Failure and edge journeys

| Scenario | Classification | Response |
| --- | --- | --- |
| Shared/coercive device | Design requirement | Explain risk, neutral/no-save use, fast delete/exit; no partner setup. |
| User wants diagnosis/treatment | Design requirement | Scope boundary and qualified-care route; no assessment score. |
...
| User is in immediate danger | Design requirement | Clear real-world emergency/crisis choices; no monitoring/rescue claim. |
