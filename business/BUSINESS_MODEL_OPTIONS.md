...
Status: Cycle 1 Draft - strategic hypotheses, not legal/tax advice
Issue: #24
...
| Model | Classification | Revenue / benefit | Mission fit | Main risk | Cycle 1 decision |
| --- | --- | --- | --- | --- | --- |
| Founder/grant-funded research | Hypothesis | Funds evidence, legal, privacy, and prototypes before revenue. | Strong for current no-production phase. | Grant agenda, runway cliff, founder dependency. | Preferred current-stage funding; terms must preserve independence. |
| Free local core + voluntary supporter membership | Hypothesis | Annual contribution funds maintenance without withholding core dignity/safety. | Strong if non-payers receive the same core. | Low conversion, donor fatigue, implied guilt/status. | First model to test conceptually. |
| EUR1 paid subscription | Hypothesis | Simple accessibility signal. | Potentially aligned. | Micro-payment fee drag, VAT/tax, support cost, cancellation burden. | Do not promise; annual/prepaid route may be more viable. |
| Freemium convenience | Hypothesis | Charge for optional sync, multi-device convenience, or non-safety customization. | Possible only after a strong free core. | Privacy-increasing service becomes the paid default; safety or access drifts behind paywall. | Defer until feature value and data cost are validated. |
| Sliding-scale / pay-it-forward | Hypothesis | Higher contributions subsidize free/low-price access. | Potentially aligned. | Complexity, fraud, shame at checkout, unpredictable revenue. | Research after basic willingness test. |
| Donations/crowdfunding | Hypothesis | Mission support without feature gating. | Aligned if donor influence and privacy are controlled. | Volatility and emotionally manipulative fundraising. | Possible supplement, not sole operating plan. |
...
| Stage | Classification | Funding / offer | Gate to advance |
| --- | --- | --- | --- |
| Research | Hypothesis | Founder/grant/donation support; no user product revenue needed. | User need, safety, privacy/legal, evidence, and MVP acceptance. |
